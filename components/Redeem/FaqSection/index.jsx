...
const data = {
  ...
  rows: [
    ...
    },
    {
      ...
      content:
        'For our Genesis drop we are covering all gas fees incurred by the winning bidder. If the NFT holder redeems the physical earrings we also cover shipping fees.',
    },
  ],
}
