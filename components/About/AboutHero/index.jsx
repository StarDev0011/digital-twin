  ...
  return (
    <AboutHeroWrapper>
      <SiteContainer>
        ...
        <AboutSubtitle>Digital Twin is a curated marketplace for fine jewelry. Intertwining the digital and physical worlds for artists and collectors.</AboutSubtitle>
        <AboutParagraph>
          {
