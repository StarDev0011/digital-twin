                    ...
                    <div className="shipping-detail-row">
                        <div className="left-bx">
                            <form action="" className="shipping-form">
                                ...
                                <div className="form-group">
                                    <label htmlFor="State">State/Province <b>*</b></label>
                        ...
                        <div className="right-bx">
                            ...
                            <div className="order-detail-bottom">
                                <p>Note: Your NFT will be transferred to L’Dezen upon redemption.</p>
                                <a href="">Redeem</a>
                            </div>

                            <a href="/redeem/physical" className="back-btn">Back</a>
